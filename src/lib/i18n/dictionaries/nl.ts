...
export const nl: Dictionary = {
  ...
  pairPlan: {
    ...
    what: "Wat stel je voor?",
    whatPlaceholder: "Koffie, zaterdagnamiddag",
    whenBoth: "Momenten waarop jullie allebei meestal vrij zijn",
    whenNone: "Een van jullie heeft nog niet gezegd wanneer die meestal vrij is. Kies hieronder zelf een moment.",
    ownTime: "Of een moment van jezelf",
    note: "Nog iets toe te voegen?",
    send: "Versturen",
    works: "Past",
    maybe: "Misschien",
    cant: "Lukt niet",
    settleOnThis: "Hierop vastleggen",
    settled: "Vastgelegd",
    waiting: "Wachten op {name}",
    bothAnswered: "{name} heeft geantwoord",
    callOff: "Toch niet doen",
    makeReal: "Er een echte afspraak van maken",
    makeRealHint:
      "Dit zet het bij Activiteiten, met een herinnering vooraf. Er wordt niets gereserveerd en niets betaald.",
    description: "Wat is het, in één lijn",
    descriptionPlaceholder: "Koffie op de hoek, en daarna wandelen als het droog blijft.",
    mode: "Online of in het echt",
    online: "Online",
  ...
  auth: {
    ...
    signInBody: "Je bunches, je plannen en je berichten staan waar je ze liet.",
