...
export const fr: Dictionary = {
  ...
  pairPlan: {
    suggest: "Propose quelque chose",
    what: "Tu proposes quoi ?",
    whatPlaceholder: "Un café, samedi après-midi",
    whenBoth: "Les moments où vous êtes tous les deux libres d’habitude",
    whenNone: "L’un de vous n’a pas encore dit quand il est libre. Choisis un moment ci-dessous.",
    ownTime: "Ou un moment à toi",
    note: "Quelque chose à ajouter ?",
    send: "Envoyer",
    works: "Ça marche",
    maybe: "Peut-être",
    cant: "Pas possible",
    settleOnThis: "On dit ça",
    settled: "C’est calé",
    waiting: "En attente de {name}",
    bothAnswered: "{name} a répondu",
    callOff: "Laisser tomber",
    makeReal: "En faire un vrai plan",
    makeRealHint:
      "Ça le met dans Activités, avec un rappel avant. Rien n’est réservé et rien n’est payé.",
    description: "C’est quoi, en une ligne",
    descriptionPlaceholder: "Un café au coin de la rue, puis une balade s’il ne pleut pas.",
    mode: "En ligne ou en vrai",
    online: "En ligne",
    inPerson: "En vrai",
    where: "Où",
  ...
  bunches: {
    ...
    invited: "Tu as été invité",
    invitedSubtitle: "Quelqu’un a pensé que tu y aurais ta place.",
    yours: "Tes bunches",
    noneTitle: "Tu n’es encore dans aucun bunch",
    noneBody:
      "Un bunch est la façon la plus simple d’entrer. Tu rejoins un groupe qui se parle déjà plutôt que de partir d’une conversation vide.",
    waiting: "En attente d’un modérateur",
    waitingSubtitle: "Tu auras une réponse dès que quelqu’un examinera ta demande.",
    fitTitle: "Des bunches qui te vont",
    fitSubtitle: "D’après tes intérêts, où tu es et quand tu es libre.",
    browse: "Parcourir",
    browseSubtitle: "Tout ce qui est public, que ça te corresponde ou non.",
    quiet: "Soirée calme dans ta ville",
    beFirst:
      "Sois le premier à créer un bunch. Un bunch avec une description réfléchie attire de meilleures personnes qu’une page de recherche vide ne le fera jamais.",
    nothingMatching: "Rien pour « {query} »",
    broaderWord: "Essaie un mot plus large, ou crée toi-même un bunch pour ça.",
    start: "Créer un bunch",
    startOne: "En créer un",
    search: "Chercher des bunches",
    searchAction: "Chercher",
    clear: "Effacer",
    searchPlaceholder: "Jeux de société, randonnée, film…",
  },
  ...
  bunchForm: {
    ...
    name: "Nom",
    namePlaceholder: "Soirées jeux d’Anvers",
    purpose: "À quoi sert ce bunch ?",
    purposeHint:
      "Dis pour qui il est et ce que vous faites vraiment. Une description claire attire de meilleures personnes qu’une description floue.",
    purposePlaceholder:
      "Un petit groupe qui se retrouve deux fois par mois pour des jeux de société costauds. Débutants bienvenus, on explique.",
    kind: "Type de bunch",
    kindInterest: "Intérêt, autour d’un sujet",
    kindLocal: "Local, autour d’un lieu",
    kindActivity: "Activité, autour de quelque chose à faire",
    whoCanJoin: "Qui peut rejoindre",
    public: "Public",
    publicNote: "Visible. Tu approuves chaque demande.",
    private: "Privé",
    privateNote: "Masqué dans Découvrir. Sur invitation uniquement.",
    maxMembers: "Nombre maximum de membres",
    maxMembersHint:
      "Plafonné à 12. Au-delà, un groupe cesse d’être un endroit où l’on te connaît.",
    where: "Où se retrouve-t-il ?",
    whereHint: "Facultatif, laisse vide pour un bunch en ligne.",
    wherePlaceholder: "Anvers",
    rules: "Règles de la maison",
    rulesHint:
      "Facultatif. Les bunches qui disent ce qu’ils attendent ont en général besoin de moins de modération.",
    rulesPlaceholder: "Viens si tu dis que tu viens. Préviens si tu ne peux pas.",
    pickInterest: "Choisis au moins un intérêt, pour que les bonnes personnes le trouvent.",
    create: "Créer le bunch",
  },

  bunch: {
    breadcrumb: "Bunches",
    chatForMembers: "Le chat est réservé aux membres",
    askToJoinBody:
      "Demande à rejoindre et un modérateur y jettera un œil. Les bunches restent petits exprès, c’est donc une vraie décision et pas une formalité.",
    whatItIsDoing: "Ce que fait ce bunch",
    planSomething: "Organiser quelque chose",
    houseRules: "Règles de la maison",
    moderator: "Modérateur",
    leaveConfirm: "Quitter ce bunch ? Tu perdras l’accès au chat.",
    leave: "Quitter",
    stay: "Rester",
    leaveBunch: "Quitter le bunch",
    requestWaiting: "Ta demande attend un modérateur.",
    acceptInvite: "Accepter l’invitation",
    cannotRejoin: "Tu ne peux pas rejoindre ce bunch à nouveau.",
    full: "Ce bunch est complet.",
    askToJoin: "Demander à rejoindre",
    approve: "Approuver",
    decline: "Refuser",
    assistant: "Demande à {brand}",
    assistantNote: "Demande un récapitulatif, ou une idée de quelque chose à faire.",
    catchMeUp: "Résume-moi",
    suggestActivity: "Propose une activité",
    turnIntoPlan: "En faire un plan →",
    thinking: "Réflexion…",
    left: "Tu as quitté le bunch.",
    inviteAccepted: "Invitation acceptée. Tu es dans le bunch.",
    requestSent: "Demande envoyée. Un modérateur va la regarder.",
    nothingToCatchUp: "Rien à rattraper.",
    notEnoughYet:
      "Pas encore assez de matière, réessaie quand le bunch aura un peu parlé.",
    chemistry: "L’alchimie du bunch",
