...
const BRAND_FILLS = ["#FF5C6C", "#7657FF", "#55D6BE", "#FFC857"] as const;
  ...
  return (
    ...
    >
      ...
      >
        {/* B */}
        <path d="M10 0 V100" />
        <path d="M10 0 H30 A25 25 0 0 1 30 50 H10" />
        <path d="M10 50 H36 A25 25 0 0 1 36 100 H10" />
        {/* u */}
        <path d="M96 28 V76 A24 24 0 0 0 144 76 V28" />
        <path d="M144 76 V100" />
        {/* n */}
        <path d="M178 100 V28" />
        <path d="M178 52 A24 24 0 0 1 226 52 V100" />
        {/* c */}
        <path d="M309 44 A26 26 0 1 0 309 84" />
        {/* h */}
        <path d="M344 0 V100" />
        <path d="M344 52 A24 24 0 0 1 392 52 V100" />
        {/* y — the hooked descender is the wordmark's one memorable detail */}
        <path d="M420 28 L444 82" />
        <path d="M468 28 L436 112 A14 14 0 0 1 414 116" />
      </g>
    </svg>
  );
}
