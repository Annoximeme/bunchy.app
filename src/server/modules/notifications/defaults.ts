...
export const NOTIFICATION_DEFAULTS: ReadonlyArray<{
  ...
  { type: "CIRCLE_INVITE", inApp: true, email: true },
  { type: "CIRCLE_JOIN_REQUEST", inApp: true, email: false },
  { type: "CIRCLE_MESSAGE_REPLY", inApp: true, email: false },
  { type: "CIRCLE_MENTION", inApp: true, email: false },
  // Suggestions are opt-in. A recommendation is our idea, not a person waiting.
  { type: "CIRCLE_RECOMMENDATION", inApp: false, email: false },
