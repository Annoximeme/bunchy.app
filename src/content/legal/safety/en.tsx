 ...
 */
export const safetyEn: LegalDocument = {
  title: "Meeting safely",
  metaDescription: `How to meet people from ${brand.name} in person, and what to do when something goes wrong.`,
