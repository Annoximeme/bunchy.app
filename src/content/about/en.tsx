...
/**
 * What Bunchy is and why it exists, in English.
 *
 * The essay, not the furniture: the bands, the measure and the headings are in
 * `components/about.tsx`, shared by all three languages. This is the one page
 * on the site written in the first person of the person who built it, which is
 * why the other two are translations of an argument rather than of a
 * paragraph, and why the pull quotes had to be rebuilt in each language rather
 * than rendered word for word.
 */
export const aboutEn: AboutDocument = {
  title: `About ${brand.name}`,
  metaDescription: `What ${brand.name} is, what it refuses to be, and who builds it. An independent project by ${LEGAL.operator}.`,
  Body: ({ startHref }) => (
    <>
